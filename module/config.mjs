export const kompetencje = /** @type {const} */ ({
  // ===== SIŁA =====
  kunszt_w_broni_bialej: {
    label: "awanturnik20.actor.atrybuty.kompetencje.kunszt_w_broni_bialej",
    atrybKey: "sila",
    umiejkaKey: "kunszt_w_broni_bialej",
  },
  mieszane_sztuki_walki: {
    label: "awanturnik20.actor.atrybuty.kompetencje.mieszane_sztuki_walki",
    atrybKey: "sila",
    umiejkaKey: "mieszane_sztuki_walki",
  },
  sprawnosc_fizyczna: {
    label: "awanturnik20.actor.atrybuty.kompetencje.sprawnosc_fizyczna",
    atrybKey: "sila",
    umiejkaKey: "sprawnosc_fizyczna",
  },
