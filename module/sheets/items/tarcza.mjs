...
export class tarczaSheet extends api.HandlebarsApplicationMixin(
  sheets.ItemSheetV2,
) {
  constructor(...args) {
    super(...args);
  ...
  static PARTS = {
    header: {
      template: `systems/awanturnik20/module/templates/items/tarcza-header.hbs`,
    },
    nav: {
      template: `systems/awanturnik20/module/templates/items/tarcza-nav.hbs`,
    },
    dane: {
      template: `systems/awanturnik20/module/templates/items/tarcza-data.hbs`,
    },
    opis: {
      template: `systems/awanturnik20/module/templates/items/tarcza-opis.hbs`,
    },
  };
  static TABS = {
    main: {
